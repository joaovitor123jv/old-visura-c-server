...
CREATE TABLE IF NOT EXISTS `teste`.`listaDesejos` (
  ...
  INDEX `fk_listaDesejos_produto1_idx` (`produto_idproduto` ASC),
...
CREATE TABLE IF NOT EXISTS `teste`.`cliente` (
  ...
  `listaDesejos_idlistaDesejos` INT NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_cliente_listaDesejos1`
    ...
    REFERENCES `teste`.`listaDesejos` (`idlistaDesejos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
