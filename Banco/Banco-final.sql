...
-- -----------------------------------------------------
-- Table `teste`.`listaDesejos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `teste`.`listaDesejos` (
  `idlistaDesejos` INT(11) NOT NULL AUTO_INCREMENT,
  `idproduto` VARCHAR(10) NOT NULL,
  `datacriacao` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `cliente_idcliente` INT(11) NOT NULL,
  PRIMARY KEY (`idlistaDesejos`),
  INDEX `fk_listaDesejos_produto1_idx` (`idproduto` ASC),
  INDEX `fk_listaDesejos_cliente1_idx` (`cliente_idcliente` ASC),
  CONSTRAINT `fk_listaDesejos_produto1`
    FOREIGN KEY (`idproduto`)
    REFERENCES `teste`.`produto` (`idproduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_listaDesejos_cliente1`
