...
INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'interface@servidor', 'Interface', 'Senatauri Enterprise', localizacao.idlocalizacao , '1', 0 from localizacao
...
INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'jv.joaovitoras@gmail.com', 'João Vitor', 'Antoniassi Segantin', localizacao.idlocalizacao , '1', 0 from localizacao
    JOIN cidade on cidade.nome = 'Auriflama'
    JOIN estado on estado.nome = 'SP'
    WHERE cidade.nome = 'Auriflama' AND estado.nome = 'SP' AND localizacao.numero = 65214;
    
INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'jv.joaopedro@gmail.com', 'João Pedro', 'Antoniassi Segantin', localizacao.idlocalizacao , '1', 0 from localizacao
    JOIN cidade on cidade.nome = 'Auriflama'
    JOIN estado on estado.nome = 'SP'
    WHERE cidade.nome = 'Auriflama' AND estado.nome = 'SP' AND localizacao.numero = 65214;
    
INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'silvia.mara@hotmail.com', 'Silvia Mara', 'Antoniassi Segantin', localizacao.idlocalizacao , '2', 0 from localizacao
    JOIN cidade on cidade.nome = 'Auriflama'
    JOIN estado on estado.nome = 'SP'
    WHERE cidade.nome = 'Auriflama' AND estado.nome = 'SP' AND localizacao.numero = 65214;

INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'carlos@gmail.com', 'Carlos Gabriel', 'Sei lá o que Stédile', localizacao.idlocalizacao , '1', 0 from localizacao
...
INSERT INTO cliente(email, nome, sobrenome, localizacao_idlocalizacao, sexo, anonimo)
	SELECT 'wemerson@gmail.com', 'Wemerson', 'Coroa Ingles', localizacao.idlocalizacao , '1', 0 from localizacao
    JOIN cidade on cidade.nome = 'Jataí'
    JOIN estado on estado.nome = 'GO'
    WHERE cidade.nome = 'Jataí' AND estado.nome = 'GO' AND localizacao.numero = 1546;
