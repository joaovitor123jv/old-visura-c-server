...
CREATE TABLE IF NOT EXISTS `mydb`.`produto` (
  ...
  `visualizacoesunicas` INT NULL DEFAULT 0,
  `visualizacaoanom` INT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `mydb`.`cliente` (
  ...
  `sobrenome` VARCHAR(64) NULL,
  `sexo` ENUM('1', '2', '3') NULL COMMENT '1 = Masculino\n2 = Feminino\n3 = Outro',
  `telefone` VARCHAR(11) NULL,
  `email` VARCHAR(64) NOT NULL,
  `datanascimento` DATE NULL,
  `senha` BLOB NULL,
  `anonimo` TINYINT NOT NULL COMMENT '1 = True (Usuário é anonimo)\n2 = False (Usuário não é anonimo)',
  `localizacao_idlocalizacao` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`visualizacaoDeUsuario` (
  `idvisualizacoes` INT NOT NULL AUTO_INCREMENT,
